    ...
    <header className="site-header">
      <a className="site-header__mark" href={home ? "#top" : "/"} aria-label={home ? `${band.name}, back to top` : `${band.name} home`}>
        ...
        {/* the name in katakana under the pill, as in the splash: fine print,
            spaced out to the pill's width exactly (textLength), whatever the
            font */}
        <svg className="site-header__ja" viewBox="0 0 154 11" lang="ja" aria-hidden="true">
          <text x="0" y="9" textLength="154" lengthAdjust="spacing">
            {band.nameJapanese}
          </text>
        </svg>
      </a>
