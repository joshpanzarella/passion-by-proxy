...
export const merch: MerchItem[] = [
  { name: "orange logo - drop shoulder", price: "$40", image: "/media/shirt-1.webp", href: "#", note: "S–XXL" },
  { name: "orange logo - reg", price: "$40", image: "/media/shirt-2.webp", href: "#", note: "S–XXL" },
];
